...
if (isset($_POST['update'])) {
    if (isset($_POST['note-dossier']) && isset($_POST['note-oral']) && isset($_POST['note-entreprise']) && isset($_POST['date-visite']) && isset($_POST['appreciation'])) {
        ...
        header("Location: PageBilan1Admin.php?idUti=" . $idUti);
        exit();
    }
}
?>
...
<div class="container">
    ...
    <div class="content-card">
        ...
        <form class="info-form" method="post" action="PageModifBilan1Admin.php?idUti=<?php echo $idUti; ?>&idBil=<?php echo $idBil; ?>">
            ...
            <div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
                ...
                <input type="button" value="Retour" class="btngris" onclick="window.location.href='PageBilan1Admin.php?idUti=<?php echo $idUti; ?>'">
            </div>
        </form>
    </div>
</div>
