...
<div class="container">
    ...
    <div class="content-card">
        ...
        <form class="info-form" method="post" action="PageAjoutBilan2.php?idUti=<?php echo $_GET['idUti']; ?>">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
                    ...
                    <input type="button" value="Retour" class="btngris" onclick="window.location.href='PageBilan2Tuteur.php?idUti=<?php echo $_GET['idUti']; ?>'">
                </div>
        </form>
        <?php
